...
duation<int, ratio<1,1>> //number of second stored in a int, default duration
duration<double, ratio<60,1>> //number of minutes stored in a double
  ns, microseconds, millionseconds, s,min,hrs
system_cleck::duration -- duration<T, system_clock::period>

Time Point:
std::chrono::time_point<>: represents a point of a time
time_point<system_cleck, milliseconds>: according to the system clock, 
	the elapsed time 运行时间 since epoch(UTC开始的时间) in milliseconds.
